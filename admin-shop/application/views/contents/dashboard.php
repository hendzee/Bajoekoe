        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?=$data_content['num_product']?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?=$data_content['num_neworder']?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
          ...
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Total Penjualan</span>              
                <?if($data_content['num_selling'] != null):?>
                    <?foreach($data_content['num_selling'] as $val):?>
                        <span class="info-box-number"><?=$val['total_selling'] ?></span>
                    <?endforeach?>
                <?else:?>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?=$data_content['num_member']?></span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
