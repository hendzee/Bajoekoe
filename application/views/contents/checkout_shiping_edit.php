                ...
                <section class="checkout checkout-step-1 checkout-step-current element-emphasis-strong clearfix">
                    ...
                    <?=form_open('Common/page_data_shiping', 'role="form"')?>                    
                        <div class="row">
                            <div class="col-xs-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="first-name" name="first-name" value="<?=$dt_first_name?>" required>
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="form-group">
                                    <label for="last-name">Nama Belakang</label>
                                    <input type="text" class="form-control" id="last-name" name="last-name" value="<?=$dt_last_name?>" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="email">Email</label>
                            <input type="email" class="form-control" id="email" name="email" value="<?=$dt_email?>" required>
                        </div>
                        <div class="form-group">
                            <label for="phone">Phone</label>
                            <input type="text" class="form-control" id="phone" name="phone" value="<?=$dt_phone?>" required>
                        </div>
                        <div class="form-group">
                            <label for="country">Negara</label>
                            <select class="chosen chosen-select-deselect form-control" name="country" id="country" data-placeholder=" " tabindex="1">
                                <option value="<?=$dt_country?>"><?=$dt_country?></option>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="region" name="province" value="<?=$dt_province?>" required>
                        </div>
                        <div class="form-group">
